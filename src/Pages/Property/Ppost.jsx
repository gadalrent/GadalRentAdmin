...
function Ppost() {
  ...
  const postGet = async () => {
    ...
    Axios.get(`${api.baseUrl}/cat/Property`)
      .then((res) => {
  ...
  const postProduct = async () => {
    ...
    postFormData.append("cat", CatC);
    postFormData.append("price", price.split(" ").join("_"));
    postFormData.append("currency", currency.split(" ").join("_"));
    postFormData.append("period", payPer.split(" ").join("_"));
    postFormData.append("rentalPeriod", rentalPeriod.split(" ").join("_"));
    postFormData.append("location", location.split(" ").join("_"));
    ...
    // }
    try {
      Axios.post(`${api.baseUrl}/property`, postFormData, {
        headers: {
            ...
            {general.length !== 0 && general[0].options.length !== 0 ? (
              <div>
                ...
                <TextField
                  ...
                  sx={{ mx: 2, my: 1, maxWidth: "400px", minWidth: "200px" }}
                >
                  {general[2].options.map((option, index) => (
                    <MenuItem
                      key={index}
                      value={option}
                      onClick={() => {
